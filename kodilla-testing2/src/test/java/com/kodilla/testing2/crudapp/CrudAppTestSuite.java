...
public class CrudAppTestSuite {
    public static final String BASE_URL = "https://mpastusiak.github.io/";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("mpastusiak@live.com");
        driverTrello.findElement(By.id("password")).sendKeys("pesel00734");
    ...
    public void deleteCrudAppTestTask(String taskName) throws InterruptedException {
        ...
        driver.findElements(By.xpath("//form[@class=\"datatable__row\"]")).stream()
                .filter(anyForm -> anyForm.findElement(By.xpath(".//p[@class=\"datatable__field-value\"]"))
                        .getText().equals(taskName))
                .forEach(anyButton -> anyButton.findElement(By.xpath(".//button[text()=\"Delete\"]")).click());

        Thread.sleep(5000);
    }

    public boolean checkTestTaskExist(String taskName) throws InterruptedException {
        driver.navigate().refresh();
    ...
    public void shouldCreateTrelloCard() throws InterruptedException {
        ...
        assertFalse(checkTestTaskExist(taskName));
    }
}
